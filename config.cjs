...
// Shadow-Xtech-V1 config.js
const fs = require("fs");
require("dotenv").config();

const config = {
  SESSION_ID: process.env.SESSION_ID || "POPKID~CYpjEQZJ#HcxxljkhqE8qSOl1YRCRe3KSEChy-_0CRNFCBQ7nHz4",
  PREFIX: process.env.PREFIX || '.',
//let's add menu captions by tappy black
   BOT_NAME: process.env.BOT_NAME || "Sʜᴀᴅᴏᴡ-Xᴛᴇᴄʜ",
   BOT: process.env.BOT || "hello 👋",
  // lets add new cmd by tappy black
...
// don't use my codes without a permission 🙏
  ...
  STATUS_READ_MSG: process.env.STATUS_READ_MSG || 'Status Viewed By Sʜᴀᴅᴏᴡ-Xᴛᴇᴄʜ',
  ...
  /*tappy black tech added anti delete cmd*/
