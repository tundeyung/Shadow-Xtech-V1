...
const port = process.env.PORT || 9090;
  ...
  let up = `*✨ Hello, Shadow-Xtech Legend! ✨*

╭─〔 *🤖 SHADOW XTECH BOT* 〕  
├─▸ *Simplicity. Speed. Power. BY Ⴊl𐌀Ꮳk𐌕𐌀ႲႲჄ!*  
╰─➤ *Your New WhatsApp Sidekick is Here!*

*❤️l Thank you for Choosing Shadow-Xtech!*
...
> _© MADE BY Ⴊl𐌀Ꮳk𐌕𐌀ႲႲჄ_`;
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('254731316204', '254759000340', '254756360306');
...
if (!isReact && senderNumber === botNumber) {
  ...
  app.get("/", (req, res) => {
  res.send("SHADOW-XTECH IS  STARTED ✅");
  });
