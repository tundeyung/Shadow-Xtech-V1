...
cmd({
    ...
    try {
        ...
        const { data: commitData } = await axios.get("https://api.github.com/repos/Tappy-Black/Shadow-Xtech-V1/commits/main");
        ...
        const { data: zipData } = await axios.get("https://github.com/Tappy-Black/Shadow-Xtech-V1/archive/main.zip", { responseType: "arraybuffer" });
        ...
        const sourcePath = path.join(extractPath, "Shadow-Xtech-V1-main");
