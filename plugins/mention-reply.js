...
cmd({
  ...
  try {
    ...
    if (m.mentionedJid.includes(botNumber)) {
      const thumbnailRes = await axios.get(config.MENU_IMAGE_URL || "https://files.catbox.moe/3hrxbh.jpg", {
      ...
      await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          isForwarded: true,
          externalAdReply: {
            title: config.BOT_NAME || "Sʜᴀᴅᴏᴡ-Xᴛᴇᴄʜ",
            body: config.DESCRIPTION || "©Powered by Sʜᴀᴅᴏᴡ-Xᴛᴇᴄʜ😇",
            mediaType: 1,
            renderLargerThumbnail: true,
            thumbnail: thumbnailBuffer,
            mediaUrl: "https://files.catbox.moe/3hrxbh.jpg", // Static image URL
